...
pde = DropletLattice(domain=domain,  mesh_file = './mesh_data/test2.vol')
...
data = loadmat("./solution_data/1000_DDDD.mat")
...
up = solver.calculate_perturb(uh=u, a=0.2, direction=perturb_direction)
