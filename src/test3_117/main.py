...
if __name__ == "__main__":
    ...
    mesh_file = "./mesh_data/lattice_0.01.vol"

    pde = DropletLattice(domain=domain, theta=90)
    ...
    # find gradient flow
    test.calc_gradientflow(solver=solver, maxit=40000)

    # find saddle
    #test.calc_saddle(solver=solver, idx=1, tol = 1e-14, maxit = 300)

    #test.calc_saddle(solver=solver, idx=1, tol = 1e-11, maxit = 40000, v0="")
