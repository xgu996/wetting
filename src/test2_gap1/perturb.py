...
pde = DropletLattice(domain=domain, mesh_file="./mesh_data/test2_gap1.vol")
...
data = loadmat("./solution_data/001_UUD.mat")
...
print(solver.b @ up)
plt.show()
savemat("./solution_data/000_UUD.mat", {"u": up.tolist() })
