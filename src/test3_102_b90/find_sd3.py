...
from src.chisd_allencahn import ChisdAllenCahn
...
data = loadmat("test3_102_b90/solution_data/000_UUU.mat")
u[:] = data["u"].flatten()
...
# 1111
# threshold = (x > 0.5) & (x < 0.53) & (y >= 0) & (y <= bottom_gap)
# u[threshold] = -1
u[(x > 0.4) & (x < 0.55) & (y >= bottom_gap) & (y <= 0.7)] = -1
u[(x > 0.53) & (x < 0.55) & (y >= bottom_gap) & (y <= 0.12)] = 1
...
print(solver.b @ up)
print(solver.b @ u)
savemat("test3_102_b90/solution_data/100_UUU.mat", {"u": up.tolist()})
plt.show()
