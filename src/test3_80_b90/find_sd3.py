...
pde = DropletLattice(domain=domain, mesh_file="./mesh_data/test3_80_b90.vol")
...
data = loadmat("./solution_data/0000_DDDD_L.mat")
u[:] = data["u"].flatten()
...
print(solver.b @ up)
print(solver.b @ u)
savemat("./solution_data/0001_DDDD_L.mat", {"u":up.tolist()})
plt.show()
