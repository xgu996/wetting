...
if __name__ == "__main__":
    ...
    pde = DropletLattice(domain=domain, mesh_file="./mesh_data/test2_heightdot12.vol")
    space = LagrangeFiniteElementSpace(pde.mesh, 1)
    p = space.interpolation_points()
    solver = ChisdAllenCahn(pde)

    # test = Test(ipath="./solution_data/0000_UUUU.mat")
    # test = Test(ipath="./solution_data/0001_UUUD.mat")
    ...
    # find saddle
    # test.calc_saddle(solver=solver, idx=1, tol=1e-11, maxit=30000)
