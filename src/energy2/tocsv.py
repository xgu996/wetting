...
data = {
    "gap": np.ones(5) * 0.08,
    "young": [102, 105, 107, 109, 112],
    "height": np.ones(5) * 0.08 * 0.8,
    "bottom_heta": np.ones(5) * 80,
    "barier_move_to_left": [0.02528, 0.02695, 0.027895, 0.028865, 0.030545],
    "barier_move_to_right": [0.02687, 0.02778, 0.028495, 0.029265, 0.030675],
}
df = pd.DataFrame(data)
print(df)
