...
pde = DropletLattice(
    domain=domain, theta=105, mesh_file="./mesh_data/test2_heightdot15.vol"
)
...
data = loadmat("./solution_data/0001_UUUD.mat")
...
perturb_direction = np.hstack((evec[:, :1].reshape(gdof, 1), evec[:, start:end]))
