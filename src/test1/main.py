...
if __name__ == "__main__":
    ...
    # pde = DropletLattice(domain=domain, theta=102, mesh_file="./mesh_data/test1.vol")
    ...
    # test = Test(ipath="./solution_data/p101_UUU.mat")
    # test = Test(ipath="./solution_data/001_UUU.mat")
    # test = Test(ipath="./solution_data/fck1.mat")
    test = Test(ipath="./solution_data/00_UU_R.mat")
    ...
    # find saddle
    # test.calc_saddle(solver=solver, idx=1, tol = 1e-11, maxit = 3000)
#
