...
x = p[..., 0]
y = p[..., 1]
# threshold = (x > 0.78) & (x < 1.0) & (y >= 0) & (y < 0.03)
# u[threshold] = -1

threshold = (x > 1) & (x < 1.1) & (y >= 0.04) & (y < 0.2)
u[threshold] = 1
...
# )
up = solver.calculate_perturb(uh=u, a=0.04, direction=perturb_direction)
plt.figure()
...
# savemat("./solution_data/0001_DDDDR.mat", {"u":up.tolist()})
plt.show()
