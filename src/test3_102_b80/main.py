...
if __name__ == "__main__":
    ...
    pde = DropletLattice(mesh_file="./mesh_data/test3_102_b80.vol", theta = 116)
    ...
    # test = Test(ipath="./solution_data/00_UU.mat")
    # test = Test(ipath="./solution_data/00_UU_L.mat")
    # test = Test(ipath="./solution_data/0_U_L.mat")
    
    # test = Test(ipath="./solution_data/01_UU.mat")
    test = Test(ipath="./solution_data/10_UU_L.mat")
    ...
    # find saddle
    test.calc_saddle(solver=solver, idx=1, tol = 1e-11, maxit = 20000)

    # test.calc_saddle(solver=solver, idx=1, tol = 1e-11, maxit = 30000, v0="")
